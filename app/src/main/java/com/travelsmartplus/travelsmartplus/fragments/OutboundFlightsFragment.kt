...
/**
 * OutboundFlightsFragment
 * Displays outbound flights results. Can be used for manual booking and to modify a predicted booking.
 *
 * @author Gabriel Salas
 */

class OutboundFlightsFragment : Fragment() {

    private lateinit var binding: FragmentOutboundFlightsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOutboundFlightsBinding.inflate(inflater, container, false)
        return binding.root
    }
